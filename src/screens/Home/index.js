...
class Home extends React.Component {
  ...
  setOnline = async () => {
   try {
          ...
          let url = dev_url + "/deliveryBoy/" + this.props.user?.userdata?.deliveryBoyPartnerId;
          let headers = {
              "Accept": "application/json",
              "Authorization": BASIC_AUTH_KEY,
              "lang": 'en_US',
          ...
          let data = {
            "status":this.state.isOnline ?"offile":"online"
          }
        ...
        <ScrollView>
          ...
          <View style={styles.bottomContainer}>
            <View style={styles.buttonView}>
              <ButtonIcon
                Icon={
                  <Icons.Entypo name="location-pin" style={styles.iconStyle} />
                }
                btnPress={() => this.setOnline()}
                label={
                  this.state.userOnline ? 'You Are  Online' : 'You Are Offline'
                }
              />
            </View>
          </View>
          ...
          <View style={[styles.bottomContainer, {marginBottom: 20}]}>
            <View style={styles.buttonView}>
              <ButtonIcon
                Icon={<Icons.AntDesign name="scan1" style={styles.iconStyle} />}
