...
function setSetting(item) {
  try {
    StringConstants = {
      ...
      PressBackAgainToExitTheApplicationLabel:
        item.PressBackAgainToExitTheApplicationLabel,
      LinkSentLabel: item.LinkSentLabel,
      RequestFailedLabel: item.RequestFailedLabel,
      ForgotPasswordRequestFailMessageLabel:
        item.ForgotPasswordRequestFailMessageLabel,
      ...
      JoinToBaytonia: item.JoinToBaytonia,
      Name: item.Name,
      ...
      AssemblyTechinician: item.AssemblyTechinician,
      Driver: item.Driver,
      VehicleDetail: item.VehicleDetail,
      SubmitYourRequest: item.SubmitYourRequest,
      BackToLogin: item.BackToLogin,
      ThanksForRegisteration: item.ThanksForRegisteration,
      WeWillBack: item.WeWillBack,
      City: item.City,
    };
  } catch (e) {
    console.log('Exception', e);
